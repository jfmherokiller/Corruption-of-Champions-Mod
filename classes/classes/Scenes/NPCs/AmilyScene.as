		...
		*/
		...
		public function talkWithCuntIMeanAmily(sexAfter:Boolean = false):void {
			...
			if (convo == 0) {
				...
				if (player.itemSlot(1).quantity == 0) {
				...
				if (player.itemSlot(1).itype == consumables.EQUINUM) {
				...
				else if (player.itemSlot(1).itype == consumables.CANINEP) {
				...
				//Canine Pepper & Variants:
				else if (player.itemSlot(1).itype == consumables.LARGEPP) {
					outputText("\"<i>Looks kind of like a dog's dick, doesn't it?  Especially this one with the big knot-like bulge or this one with the ball-like bulbs.  I suppose it would make you more dog-like... but I'm pretty sure you should avoid these jet-black ones.  I can't remember why...</i>\" she trails off, wracking her brain.\n\n");
				}
				//Canine Pepper & Variants:
				else if (player.itemSlot(1).itype == consumables.DBLPEPP) {
					outputText("\"<i>Looks kind of like a dog's dick, doesn't it?  Especially this one with the big knot-like bulge or this one with the ball-like bulbs.  I suppose it would make you more dog-like... but I'm pretty sure you should avoid these jet-black ones.  I can't remember why...</i>\" she trails off, wracking her brain.\n\n");
				}
				//Canine Pepper & Variants:
				else if (player.itemSlot(1).itype == consumables.BLACKPP) {
					outputText("\"<i>Looks kind of like a dog's dick, doesn't it?  Especially this one with the big knot-like bulge or this one with the ball-like bulbs.  I suppose it would make you more dog-like... but I'm pretty sure you should avoid these jet-black ones.  I can't remember why...</i>\" she trails off, wracking her brain.\n\n");
				}
				//Canine Pepper & Variants:
				else if (player.itemSlot(1).itype == consumables.KNOTTYP) {
					outputText("\"<i>Looks kind of like a dog's dick, doesn't it?  Especially this one with the big knot-like bulge or this one with the ball-like bulbs.  I suppose it would make you more dog-like... but I'm pretty sure you should avoid these jet-black ones.  I can't remember why...</i>\" she trails off, wracking her brain.\n\n");
				}
				//Canine Pepper & Variants:
				else if (player.itemSlot(1).itype == consumables.BULBYPP) {
					outputText("\"<i>Looks kind of like a dog's dick, doesn't it?  Especially this one with the big knot-like bulge or this one with the ball-like bulbs.  I suppose it would make you more dog-like... but I'm pretty sure you should avoid these jet-black ones.  I can't remember why...</i>\" she trails off, wracking her brain.\n\n");
				}
				//Succubus Milk/Incubus Draft:
				else if (player.itemSlot(1).itype == consumables.INCUBID || player.itemSlot(1).itype == consumables.SUCMILK) {
				...
				//Succubi's Delight:
				else if (player.itemSlot(1).itype == consumables.SDELITE) {
				...
				//Wet Cloth:
				else if (player.itemSlot(1).itype == consumables.WETCLTH) {
				...
				//Bee Honey:
				else if (player.itemSlot(1).itype == consumables.BEEHONY) {
				...
				//Pure Honey:
				else if (player.itemSlot(1).itype == consumables.PURHONY) {
				...
				//Whisker Fruit:
				else if (player.itemSlot(1).itype == consumables.W_FRUIT) {
				...
				else if (player.itemSlot(1).itype == consumables.PIGTRUF || player.itemSlot(1).itype == consumables.BOARTRU) {
				...
				//Green Glob:
				else if (player.itemSlot(1).itype == useables.GREENGL) {
				...
				//Bee Chitin:
				else if (player.itemSlot(1).itype == useables.B_CHITN) {
				...
				//Spider Silk:
				else if (player.itemSlot(1).itype == useables.T_SSILK) {
				...
				//Dragon Scale:
				else if (player.itemSlot(1).itype == useables.D_SCALE) {
				...
				//Imp Skull:
				else if (player.itemSlot(1).itype == useables.IMPSKLL) {
		...
		private function talkWithCORRUPTCUNT(sexAfter:Boolean = false):void {
			...
			if (convo == 0) {
				...
				//Whisker Fruit:
				if (player.itemSlot(1).itype == consumables.W_FRUIT) {
				...
				//Pigtail or Boar Truffle:
				if (player.itemSlot(1).itype == consumables.PIGTRUF || player.itemSlot(1).itype == consumables.BOARTRU) {
