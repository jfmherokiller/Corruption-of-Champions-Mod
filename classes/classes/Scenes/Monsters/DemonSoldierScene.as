package classes.Scenes.Monsters 
{
	...
	public class DemonSoldierScene extends BaseContent
	{
		...
		private function giveTheDemonGoodFacial():void {
			...
			outputText("You approach the vanquished " + (monster as DemonSoldier).demonTitle() + " " + (player.cor < 40 ? "hesitantly" : (player.cor < 75 ? "with a wicked grin on your face" : "positively salivating at the prospect of raping {him / her} senseless")) + ", and quickly set about stripping both yourself and your victim naked.");
			...
			outputText("so you dress quickly and leave the Demon work out " + monster.mf("his", "her") + " frustrations on " + monster.mf("his", "her") + " own; the wet, urgent sounds of energetic self - abuse following you as you head off.");
		...
		public function defeatedBySoldier(hpVictory:Boolean):void {
			clearOutput();
			outputText("Lying prostrate at the Demon Soldier's feet, you are barely even aware of the " + (monster as DemonSoldier).demonTitle() + " stripping off your [Armour]. {He/She} It takes the opportunity to run " + monster.mf("his", "her") + " hands across your helpless body, murmuring to " + monster.mf("him", "her") + "self, \"<i>Very nice, I can certainly work with this...</i>\"");
			...
			outputText("So saying, the Demon " + (player.gems == 1 ? "pulls a classic dick move by taking your last gem, then" : "helps " + monster.mf("him", "her") + "self to a handful of Gems from your pouch, then") + " spreads " + monster.mf("his", "her") + " wings and, with a mighty heave, launches " + monster.mf("him", "her") + "self into the air. You raise your head just long enough to see the hell beast rise until " + monster.mf("he", "she") + "'s little more than a dot in the sky, then slump back into the dirt and finally pass out.");
		...
		private function demonLossSceneDicked():void {
			/*
			Demon victory rape 1 (Incubus/Omnibus/She-male)
...
You can just about manage a groan before you flopping onto the cum-splattered earth as infernal sperm flows freely from your ruined orifice.
		...
		private function demonLossScenePussied():void {
			/*
						Demon victory rape 2 (Omnibus/Succubus/Cunt-boy)

Lying prostrate at the Demon Soldier's feet, you are barely even aware of the [if(ehasPenis = true {and} ehasVagina = true {and} ehasBreasts = true) " Omnibus "][if(ehasPenis = false {and} ehasVagina = true {and} ehasBreasts = true) " Succubus "][if(ehasPenis = true {and} ehasVagina = true {and} ehasBreasts = false) " Masculine Omnibus "][if(ehasPenis = false {and} ehasVagina = true {and} ehasBreasts = false) " Demonic Cunt-boy "] stripping off your [Armour]. {He/She} It takes the opportunity to run " + monster.mf("his", "her") + " hands across your helpless body, murmuring to " + monster.mf("him", "her") + "self; "Very nice, I can certainly work with this..."
...
<i>"Mmmmm, delicious."</i> {He/She} hisses <i>"Now, let's put that pretty little mouth of yours to good use."</i>
